...
async def test_midjourney_integration():
    ...
    try:
        ...
        print("✅ 测试2: 数据模型验证成功")
        print(f"   - 配置: enabled={config.enabled}, fast_credits={config.fast_credits}")
    ...
    # 测试5: 验证前端API客户端文件
    try:
        api_client_path = '/Users/liuqingliang/openwebui/openwebui-main/src/lib/apis/midjourney.js'
    ...
    # 测试6: 验证主程序集成
    try:
        main_py_path = '/Users/liuqingliang/openwebui/openwebui-main/backend/open_webui/main.py'

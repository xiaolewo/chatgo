...
def test_file_structure():
    ...
    files_to_check = [
        ...
        },
        {
            ...
            'required_content': ['export const', 'getMidJourneyConfig', 'generateImage']
        },
        {
...
def test_backend_router():
    ...
    try:
        ...
        # 检查关键数据模型
        models = ['MidJourneyConfig', 'ImageGenerateRequest', 'TaskResponse', 'TaskStatusResponse']
        missing_models = []
        for model in models:
...
def test_admin_settings():
    ...
    if os.path.exists(settings_path):
        try:
            ...
            # 检查MidJourney标签页
            if "selectedTab === 'midjourney'" in content and 'import MidJourney' in content:

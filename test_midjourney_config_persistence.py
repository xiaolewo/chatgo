...
def test_midjourney_config_persistence():
    ...
    try:
        ...
        print(f"      API_KEY: {MIDJOURNEY_API_KEY.value[:20] if MIDJOURNEY_API_KEY.value else 'None'}...")
    ...
    try:
        ...
        if os.path.exists(config_file):
            ...
            checks = [
                ...
                ("PersistentConfig usage", "PersistentConfig(" in content and "midjourney." in content),
            ]

...
app.state.config.WECHAT_WELCOME_ENABLED = WECHAT_WELCOME_ENABLED
app.state.config.WECHAT_WELCOME_MESSAGE = WECHAT_WELCOME_MESSAGE
app.state.config.WECHAT_AUTO_REPLY_ENABLED = WECHAT_AUTO_REPLY_ENABLED
app.state.config.WECHAT_DEFAULT_REPLY_MESSAGE = WECHAT_DEFAULT_REPLY_MESSAGE
app.state.config.WECHAT_KEYWORD_REPLIES = WECHAT_KEYWORD_REPLIES

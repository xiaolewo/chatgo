    ...
    async with httpx.AsyncClient() as client:
        ...
        try:
            ...
            if account_response.status_code == 200:
                ...
                print(f"账户信息: {json.dumps(account_data, indent=2, ensure_ascii=False)}")
            else:
        ...
        try:
            usage_response = await client.get(
                f"{API_URL}/v1/dashboard/billing/usage", 
                headers=headers, 
                timeout=10
            )
            ...
            if usage_response.status_code == 200:
                ...
                print(f"使用情况: {json.dumps(usage_data, indent=2, ensure_ascii=False)}")
            else:
        ...
        for key_name, key_value in [("新密钥", API_KEY), ("旧密钥", old_key)]:
            ...
            try:
                ...
                if models_response.status_code == 200:
                    ...
                    mj_models = [m for m in models_data.get('data', []) if 'mj' in m.get('id', '').lower()]
        ...
        try:
            ...
            print(f"快速提交结果: {json.dumps(submit_result, indent=2, ensure_ascii=False)}")
